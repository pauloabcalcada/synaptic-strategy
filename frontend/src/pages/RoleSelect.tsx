...
export function RoleSelect() {
  ...
  function chooseExecutive() {
    setRole("executive", null);
    navigate("/executive");
  }

  function chooseArea(area: AreaSummary) {
    setRole("manager", area.id);
    navigate("/area");
  }

  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-10 bg-background px-6 py-16 text-center">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="max-w-md text-muted-foreground">
          Explore the portfolio-wide executive view, or step into a
          department manager's seat.
        </p>
      </div>
